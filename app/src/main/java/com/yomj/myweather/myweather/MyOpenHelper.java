...
public class MyOpenHelper extends SQLiteOpenHelper{
    ...
    public static final String CRESTE_WEATHER_CODE = "create table WeatherCode (id integer primary key autoincrement, weather_code text,weather_text text,weather_icon text";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CRESTE_WEATHER_CODE);
    }
